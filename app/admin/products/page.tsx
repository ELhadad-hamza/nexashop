    ...
    <main>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16">
        ...
        <div className="mt-10 overflow-hidden rounded-3xl border border-zinc-200 bg-white shadow-sm">
          <div className="grid grid-cols-5 gap-4 border-b border-zinc-200 px-6 py-4 text-sm font-semibold text-zinc-500">
            <span>Nom</span>
            <span>Catégorie</span>
            <span>Prix</span>
            <span>Stock</span>
          ...
          {products.map((product) => (
            <div
              key={product.id}
              className="grid grid-cols-5 gap-4 border-b border-zinc-100 px-6 py-4 text-sm"
            >
